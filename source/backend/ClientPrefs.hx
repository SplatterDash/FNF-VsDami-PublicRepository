...
@:structInit class SaveVariables {
	...
	public var mouseUI:Bool = #if desktop true #else false #end;
	public var mouseTex:String = 'Default Mouse';
	...
	public var pauseMusic:String = 'Dami Themes';
...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		#if desktop
		if (data.mouseTex != 'Default Mouse')
			FlxG.mouse.load("assets/shared/images/mice/damimouse.png", 1, 0, 0);
		#end
