 ...
 * - LOW QUALITY ONLY = 1 (0000 0001)
 * - HIGH QUALITY ONLY = 2 (0000 0010)
 * - LOW + HIGH QUALITY = 3 (0000 0011)
 * - STORY MODE ONLY = 4 (0000 0100)
 * - STORY MODE + LOW QUALITY ONLY = 5 (0000 0101)
 * - STORY MODE + HIGH QUALITY ONLY = 6 (0000 0110)
 * - FREEPLAY ONLY = 8 (0000 1000)
 * - FREEPLAY + LOW QUALITY ONLY = 9 (0000 1001)
 * - FREEPLAY + HIGH QUALITY ONLY = 10 (0000 1010)
 * 
