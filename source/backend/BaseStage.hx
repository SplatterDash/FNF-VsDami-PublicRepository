...
class BaseStage extends FlxBasic
{
	...
	public function addInFrontOfBF(obj:FlxBasic) return insert(members.indexOf(game.boyfriendGroup) + 1, obj);
	...
	inline private function get_currentCamZoom():Float return game.defaultCamZoom;
