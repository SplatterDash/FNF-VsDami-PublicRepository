...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	[
		...
		['Snap To Character', "Value 1: Character to snap to"],
		['New Camera Zoom', 'Value 1: New zoom value (leave blank for default)\nValue 2: Ease time (leave blank for snap)'],
		["Snap To Center", 'yer.'],
		["Aidan Anims", 'Value 1: Animation name'],
		["Toggle Special Move", '$12.78'],
		["BG Event", "May need other values depending on stage."],
		["Health Stop", "Stops your health."],
		['Mid-Song Countdown', "Plays a countdown in the middle of the song.\nValue 1: Mute the countdown sounds.\nValue 2: Flicker the GO sprite."],
		["Fake-Out", "For Dami-Nate (ERECT Remix)"],
		["Shunkly Bobm", ""],
		["Play Video Mid-Song", "Plays a video in the middle of a song.\nValue 1: File name of video\nValue 2: Should it play over the arrows? (Default is true)"],
		["Ghost Anim", "Does ghost anims on jacks.\nValue 1: Specific character (dad or bf). Default is both.\nValue 2: Turn on (\"on\") or off (off by default)."],
		["Camera Follow Chars", "Refer to FNF:3D for what this is."],
		["Erect Dialogue", "someone help, Dami trapped me in the basement and he's making my sona into an FNF song, oH NO I HEAR HIM COMI-"],
		["Force Vocal Volume", "Forcing a vocal to be a specific volume.\nValue 1: Float volume\nValue 2: Character to change vocals (default: opponent/main)"],
		["Tutorial Zoom", "I'm gonna say it: 67 is cringe, 21 is life"],
		["Camera Bars", "Value 1: How much of the screen should the bars cover?\nValue 2: Duration of transition"],
		["Change Character Cam Points", "Value 1: Character to target (default: opponent)\nValue 2: How much to change cam point by (X,Y)"],
		["Camera Fade", "Value 1: Duration of fade, in seconds.\nValue 2: Options. Include a comma between certain options (\"white\" for white fade, \"in\" for fade in, \"reset\" for auto-reset fade after completing)."],
		["Dad Trail", "in order to beat them, I'll need to become SONIC... UNLEASHED!"],
		["Erect Dialogue", "Only for Dami-Nate (ERECT Remix)."],
		["Erect BG", "Value 1: Put 'reverse' to go to full opacity; leave blank for 0.3 BG opacity."],
		["Opponent Screen Shake", "Value 1: Shake intensity (default is 0.01) or put \"OFF\" to turn off.\nValue 2: Light shaking when focused on player? (Leave blank for no)"],
		["Reawaken Scenes", 'Value 1: Choose one of the following:\n- calmer start/move/end\n- finale\n- finale transition \n- reset'],
		["Camera Flash", "Value 1: Duration of the flash"]
	];
