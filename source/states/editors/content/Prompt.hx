...
class Prompt extends BasePrompt
{
	...
	var singleOption:Bool = false;
	public function new(title:String, yesFunction:Void->Void, ?noFunction:Void->Void, ?_yesTxt:String, ?_noTxt:String, ?singleOption:Bool = false)
	{
